...
def start_producer():
    ...
    subprocess.run(f"{spark_path} --packages org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.0 --conf spark.cores.max=1 producer/producer.py", shell=True, check=True, cwd=repo_dir_path)
